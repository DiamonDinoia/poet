...
option(POET_ENABLE_ASAN "Enable AddressSanitizer" OFF)
option(POET_ENABLE_UBSAN "Enable UndefinedBehaviorSanitizer" OFF)
option(POET_ENABLE_TSAN "Enable ThreadSanitizer" OFF)
option(POET_ENABLE_MSAN "Enable MemorySanitizer" OFF)

function(_poet_any_sanitizer_enabled out_var)
  if(POET_ENABLE_ASAN OR POET_ENABLE_UBSAN OR POET_ENABLE_TSAN OR POET_ENABLE_MSAN)
...
function(_poet_prepare_sanitizers out_var)
  ...
  if(_status)
    ...
    set(SANITIZE_THREAD ${POET_ENABLE_TSAN} CACHE BOOL
      "Enable ThreadSanitizer for sanitized targets." FORCE)
    mark_as_advanced(SANITIZE_THREAD)

    set(SANITIZE_MEMORY ${POET_ENABLE_MSAN} CACHE BOOL
...
function(poet_enable_sanitizers target)
  ...
  if(_target_type STREQUAL "INTERFACE_LIBRARY")
    ...
    if(POET_ENABLE_TSAN)
      list(APPEND _requested_sanitizers TSan)
    endif()
    if(POET_ENABLE_MSAN)
      list(APPEND _requested_sanitizers MSan)
    endif()
