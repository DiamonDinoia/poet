...
- `examples/dispatch.cpp
  <https://github.com/DiamonDinoia/poet/blob/main/examples/dispatch.cpp>`_
  — single and multi-parameter dispatch.
  |ce-badge| `Try on Compiler Explorer <https://diamondinoia.github.io/poet/dispatch.html>`_
- `examples/dispatch_set.cpp
  <https://github.com/DiamonDinoia/poet/blob/main/examples/dispatch_set.cpp>`_
  — sparse combinations and ``throw_on_no_match``.
  |ce-badge| `Try on Compiler Explorer <https://diamondinoia.github.io/poet/dispatch_set.html>`_
- `examples/polynomial.cpp
  <https://github.com/DiamonDinoia/poet/blob/main/examples/polynomial.cpp>`_
  — Horner's method specialised on a runtime-chosen degree, combined
  with ``static_for`` to unroll the recurrence.
  |ce-badge| `Try on Compiler Explorer <https://diamondinoia.github.io/poet/polynomial.html>`_
